...
static ::_pb::Metadata file_level_metadata_hello_5fworld_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_hello_5fworld_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_hello_5fworld_2eproto = nullptr;

const uint32_t TableStruct_hello_5fworld_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_hello_5fworld_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021hello_world.proto\022\nhelloworld\"\034\n\014Hello"
  "Request\022\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007m"
  "essage\030\001 \001(\t2G\n\007Greeter\022<\n\010SayHello\022\030.he"
  "lloworld.HelloRequest\032\026.helloworld.Hello"
  "Replyb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_hello_5fworld_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_hello_5fworld_2eproto = {
    false, false, 173, descriptor_table_protodef_hello_5fworld_2eproto,
    "hello_world.proto",
    &descriptor_table_hello_5fworld_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_hello_5fworld_2eproto::offsets,
    file_level_metadata_hello_5fworld_2eproto, file_level_enum_descriptors_hello_5fworld_2eproto,
    file_level_service_descriptors_hello_5fworld_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_hello_5fworld_2eproto_getter() {
  return &descriptor_table_hello_5fworld_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_hello_5fworld_2eproto(&descriptor_table_hello_5fworld_2eproto);
namespace helloworld {
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_hello_5fworld_2eproto_getter, &descriptor_table_hello_5fworld_2eproto_once,
      file_level_metadata_hello_5fworld_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata HelloReply::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_hello_5fworld_2eproto_getter, &descriptor_table_hello_5fworld_2eproto_once,
      file_level_metadata_hello_5fworld_2eproto[1]);
}
